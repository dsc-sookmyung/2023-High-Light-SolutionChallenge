...
def get_image(data, path, image_path):
    ...
    for i in range(len(pdf)):
        ...
        for image in images:
            ...
            img.save(
                open(local_image_path + f"/image_{image_count}.{extension}", "wb"))
            each_page.append({
...
#     page = extract_data[str(i + 1)]
#     full_text_audio_url = page["full_text"]["audio_url"]
#     text_audio_url = page["text"]["audio_url"]
